 ...
 * @author claas
 */
public class Hold extends SingleLineCommand<String> {

    public enum HoldParam {
        ON, OFF, RELEASE
    }

    public Hold(BlockingQueue<Command> queue, HoldParam holdParam) {
        super(queue, "hold " + holdParam.name().toLowerCase());
    }
