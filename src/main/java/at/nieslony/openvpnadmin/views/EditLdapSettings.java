    ...
    implements Serializable, LdapHelperUser
{
    ...
    private void saveJaasConf() {
        String filename = String.format("%s/jaas.conf", folderFactory.getConfigDir());
        String className = LdapSettings.class.getName();
        ...
        try {
            ...
            pw.println("/**");
            pw.println(" * Generated by arachne");
            pw.println(" */");
            pw.println(String.format("%s {", className));
            pw.println("  com.sun.security.auth.module.Krb5LoginModule required client=TRUE");
            pw.println("  debug=\"true\"");
            pw.println("  doNotPrompt=\"true\"");
            pw.println("  refreshKrb5Config=\"true\"");
            pw.println("  useKeyTab=\"true\"");
            pw.println(String.format("  keyTab=\"%s\"", getKeytabFile()));
            pw.println(String.format("  principal=\"%s\"", getKerberosPrincipal()));
            pw.println("  ;");
            pw.println("};");
            ...
            logger.warning(String.format("Cannot write %s: %s",
                    filename, ex.getMessage()));
        }
    }

    public void onSave() {
        if (getAuthType() == LdapSettingsBase.LdapAuthType.GSSAPI)
            saveJaasConf();
        else
